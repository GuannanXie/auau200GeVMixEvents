...
namespace topoCuts
{
   ...
   {
      {0.0106, 0.0106, 0.0073, 0.0057, 0.0046, 0.0030}, // 60-80%
      {0.0140, 0.0100, 0.0075, 0.0072, 0.0060, 0.0042}, // 40-60%
      {0.0151, 0.0102, 0.0104, 0.0099, 0.0063, 0.0042}, // 20-40%
      {0.0145, 0.0113, 0.0094, 0.0089, 0.0069, 0.0048}, // 10-20%
      {0.0138, 0.0109, 0.0082, 0.0094, 0.0076, 0.0054}  // 0-10%
   };
   float const pDca[nCent][nPtBins] =
   {
      {0.0098, 0.0098, 0.0080, 0.0066, 0.0049, 0.0042}, // 60-80%
   ...
   {
      {0.0076, 0.0076, 0.0090, 0.0056, 0.0069, 0.0050}, // 60-80%
   ...
   {
      {0.0077, 0.0077, 0.0123, 0.0117, 0.0106, 0.0091}, // 60-80%
   ...
   {
      {0.0175, 0.0175, 0.0163, 0.0167, 0.0160, 0.0170}, // 60-80%
   ...
   {
      {0.0107, 0.0107, 0.0075, 0.0098, 0.0069, 0.0044}, // 60-80%
   ...
   {
      {0.0115, 0.0115, 0.0085, 0.0085, 0.0080, 0.0054}, // 60-80%
   ...
   {
      {0.0056, 0.0045, 0.0054, 0.0048, 0.0037, 0.0030}, // 60-80%
   ...
   {
      {0.0103, 0.0103, 0.0111, 0.0071, 0.0085, 0.0090}, // 60-80%
   ...
   {
      {0.0216, 0.0216, 0.0221, 0.0211, 0.0158, 0.0212}, // 60-80%
   ...
   {
      {0.0092, 0.0092, 0.0050, 0.0039, 0.0030, 0.0020}, // 60-80%
      {0.0115, 0.0114, 0.0067, 0.0050, 0.0040, 0.0035}, // 40-60%
      {0.0134, 0.0112, 0.0074, 0.0063, 0.0050, 0.0035}, // 20-40%
      {0.0135, 0.0120, 0.0070, 0.0060, 0.0050, 0.0035}, // 10-20%
      {0.0111, 0.0109, 0.0080, 0.0067, 0.0050, 0.0035}  // 0-10%
   };
   float const pDca2[nCent][nPtBins] =
   {
      {0.0096, 0.0096, 0.0058, 0.0042, 0.0029, 0.0020}, // 60-80%
      {0.0124, 0.0114, 0.0072, 0.0050, 0.0040, 0.0035}, // 40-60%
      {0.0111, 0.0113, 0.0089, 0.0062, 0.0050, 0.0035}, // 20-40%
      {0.0108, 0.0100, 0.0074, 0.0069, 0.0050, 0.0037}, // 10-20%
      {0.0116, 0.0105, 0.0093, 0.0072, 0.0050, 0.0041}  // 0-10%
   };
   float const dcaV0ToPv2[nCent][nPtBins] =
   {
      {0.0077, 0.0077, 0.0097, 0.0085, 0.0077, 0.0059}, // 60-80%
   ...
   {
      {0.0109, 0.0109, 0.0136, 0.0116, 0.0123, 0.0124}, // 60-80%
   ...
   {
      {0.0158, 0.0139, 0.0125, 0.0118, 0.0117, 0.0133}, // 60-80%
